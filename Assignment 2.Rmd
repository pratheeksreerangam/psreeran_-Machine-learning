...
## Added client information and converted the categorical information to elements.

```{r}
getwd()
setwd("C:/Users/prath/OneDrive/Documents/ML")
...
##used relevant details to divide the collection into training (60%) and validation (40%)..
...
## Normalizing the data in numerical form.
